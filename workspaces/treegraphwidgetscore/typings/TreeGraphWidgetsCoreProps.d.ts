/**
 * This file was generated from TreeGraphWidgetsCore.xml
...
export interface TreeGraphWidgetsCoreContainerProps {
    name: string;
    class: string;
    style?: CSSProperties;
    tabIndex?: number;
...
export interface TreeGraphWidgetsCorePreviewProps {
    /**
